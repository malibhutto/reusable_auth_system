...
export const validateSignup = [
  body('firstName')
    ...
    .isAlpha('en-US', { ignore: ' ' }).withMessage('First name must contain only alphabets'),

  body('lastName')
    .trim()
    .notEmpty().withMessage('Last name is required')
    .isAlpha('en-US', { ignore: ' ' }).withMessage('Last name must contain only alphabets'),
...
export const validateVerifyEmail = [
  ...
  body('otp')
    ...
    .isNumeric().withMessage('OTP code must contain numbers only'),
